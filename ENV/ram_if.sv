...
interface ram_if (
  ...
  clocking drv_cb @(negedge clk);
    ...
    //Here #1 is used to intriduce delay for sampling and driving in the  driver block to avoid race conditions
  ...
  clocking mon_cb @(posedge clk);
    ...
    //Here monitor only samples that is why we use #1 for input and no delay for ouput
